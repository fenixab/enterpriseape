class Invoices::PurchasesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @purchase.save
        format.html { redirect_to @invoice, notice: 'The Purchase was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @purchase.update(purchase_params)
        format.html { redirect_to @invoice, notice: 'The Purchase was successfully updated.'}
